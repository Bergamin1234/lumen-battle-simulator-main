...
class BotState(enum.Enum):
    ...
    RETURNING_TO_HEAL = "RETURNING_TO_HEAL"
    HEALING = "HEALING"
...
class BotStateMachine:
    ...
    def __init__(self, initial_state: BotState = BotState.IDLE) -> None:
        ...
        self._allowed_transitions: Dict[BotState, Set[BotState]] = {
            BotState.IDLE: {BotState.STARTING, BotState.INITIALIZING, BotState.MANUAL, BotState.EMERGENCY_STOP, BotState.SAFE_STOP, BotState.OBSERVING, BotState.EXPLORING, BotState.BATTLE, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.DIALOG, BotState.LOADING_SCREEN, BotState.NETWORK_RECONNECTING},
            ...
            BotState.OBSERVING: {BotState.EXPLORING, BotState.BATTLE_DETECTED, BotState.BATTLE, BotState.DIALOG, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.LOADING_SCREEN, BotState.NETWORK_RECONNECTING, BotState.UNRESPONSIVE_RECOVERY, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP, BotState.MANUAL},
            BotState.EXPLORING: {BotState.OBSERVING, BotState.BATTLE_DETECTED, BotState.BATTLE, BotState.DIALOG, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.LOADING_SCREEN, BotState.NETWORK_RECONNECTING, BotState.UNRESPONSIVE_RECOVERY, BotState.RECOVERING, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            ...
            BotState.BATTLE_MODAL_DISMISSAL: {BotState.POST_BATTLE_EVALUATION, BotState.EXPLORING, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.BATTLE, BotState.OBSERVING, BotState.LOADING_SCREEN, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            BotState.POST_BATTLE_EVALUATION: {BotState.EXPLORING, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.OBSERVING, BotState.LOADING_SCREEN, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            BotState.RETURNING_TO_HEAL: {BotState.HEALING, BotState.EXPLORING, BotState.OBSERVING, BotState.LOADING_SCREEN, BotState.NETWORK_RECONNECTING, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            ...
            BotState.HEALING: {BotState.OBSERVING, BotState.EXPLORING, BotState.RETURNING_TO_HEAL, BotState.RECOVERING, BotState.LOADING_SCREEN, BotState.NETWORK_RECONNECTING, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            BotState.VICTORY: {BotState.OBSERVING, BotState.EXPLORING, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.POST_BATTLE_EVALUATION, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
            BotState.DEFEAT: {BotState.OBSERVING, BotState.EXPLORING, BotState.HEALING, BotState.RETURNING_TO_HEAL, BotState.POST_BATTLE_EVALUATION, BotState.RECOVERING, BotState.STOPPING, BotState.EMERGENCY_STOP, BotState.SAFE_STOP},
