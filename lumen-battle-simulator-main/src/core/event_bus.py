...
class EventType(str, Enum):
    ...
    # Percepção & Combate v3.7, v3.8 & v3.9 (Battle UI, Closed-Loop, Modals & Safety)
    BATTLE_UI_DETECTED = "BATTLE_UI_DETECTED"
    BATTLE_UI_CONFIRMED = "BATTLE_UI_CONFIRMED"
    FIGHT_DETECTED = "FIGHT_DETECTED"
    FIGHT_CLICK_REQUESTED = "FIGHT_CLICK_REQUESTED"
    FIGHT_CLICK_DISPATCHED = "FIGHT_CLICK_DISPATCHED"
    FIGHT_CLICK_VERIFIED = "FIGHT_CLICK_VERIFIED"
    SKILL_UI_DETECTED = "SKILL_UI_DETECTED"
    SKILL_DETECTED = "SKILL_DETECTED"
    SKILL_SELECTED = "SKILL_SELECTED"
    SKILL_ACTION_REQUESTED = "SKILL_ACTION_REQUESTED"
    SKILL_ACTION_DISPATCHED = "SKILL_ACTION_DISPATCHED"
    SKILL_ACTION_VERIFIED = "SKILL_ACTION_VERIFIED"
    BATTLE_WAITING_TURN_RESOLUTION = "BATTLE_WAITING_TURN_RESOLUTION"
    TURN_RESOLUTION_COMPLETED = "TURN_RESOLUTION_COMPLETED"
    MODAL_DETECTED = "MODAL_DETECTED"
    MODAL_DISMISSED = "MODAL_DISMISSED"
    BATTLE_EXIT_DETECTED = "BATTLE_EXIT_DETECTED"
    BATTLE_FINISHED = "BATTLE_FINISHED"
    WORLD_RESUMED = "WORLD_RESUMED"
    BATTLE_WATCHDOG_TRIGGERED = "BATTLE_WATCHDOG_TRIGGERED"
    INPUT_GUARD_REJECTED = "INPUT_GUARD_REJECTED"
    ...
    CRYSTAL_DETECTION_DISABLED_IN_BATTLE = "CRYSTAL_DETECTION_DISABLED_IN_BATTLE"
    PERCEPTION_CONTEXT_CHANGED = "PERCEPTION_CONTEXT_CHANGED"

    # v4.3 Live Supervisor, Self-Healing & Field Trial Events
    WEBGL_FRAME_FREEZE_DETECTED = "WEBGL_FRAME_FREEZE_DETECTED"
    WINDOW_RESTORED = "WINDOW_RESTORED"
    POPUP_DISMISSED = "POPUP_DISMISSED"
    FIELD_TRIAL_CYCLE_COMPLETED = "FIELD_TRIAL_CYCLE_COMPLETED"
    FIELD_TRIAL_PASSED = "FIELD_TRIAL_PASSED"
    FIELD_TRIAL_FAILED = "FIELD_TRIAL_FAILED"

    # v4.4 UIPI / UAC & Hardware Gate Events
    WARNING_UIPI_ELEVATION_MISMATCH = "WARNING_UIPI_ELEVATION_MISMATCH"
    INPUT_DISPATCH_REJECTED_BY_OS = "INPUT_DISPATCH_REJECTED_BY_OS"

    # v5.3 Recorded Path & Healing Events
    HEALING_COMPLETED = "HEALING_COMPLETED"
    CRYSTAL_INTERACTION_DISPATCHED = "CRYSTAL_INTERACTION_DISPATCHED"
    ...
    CRYSTAL_NOT_PRESENT_ON_CURRENT_MAP = "CRYSTAL_NOT_PRESENT_ON_CURRENT_MAP"
